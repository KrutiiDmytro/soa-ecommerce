...
use App\Infrastructure\DoctrineCustomerRepository;
...
class Kernel extends BaseKernel
{
    ...
    protected function configureContainer(ContainerConfigurator $c): void
    {
        ...
        // Прив'язка доменного порту репозиторію до Doctrine-реалізації.
        $services->alias(CustomerRepository::class, DoctrineCustomerRepository::class);

        // Контролери — публічні + приймають сервіс-аргументи.
