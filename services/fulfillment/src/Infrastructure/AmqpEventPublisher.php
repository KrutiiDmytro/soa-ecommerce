...
/**
 * Публікація доменних подій у topic-exchange RabbitMQ (`printzone.events`).
 * Ключі маршрутизації: payment.captured, shipment.dispatched.
 * З'єднання відкривається лениво — health-endpoint не має залежати від брокера.
 */
